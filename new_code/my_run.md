...
python extract_llnm_shape_echo.py \
  ...
  --image_root /mnt/wangbd8/workspace/DataSets/ThyroidAgent/Classifaction_Data/Malignant_ultrasound_images_cropped \
  --mask_dir /mnt/wangbd8/workspace/DataSets/ThyroidAgent/Classifaction_Data/Malignant_ultrasound_images_cropped_predictions \
  --output_csv ./output/test_shape_echo.csv \
  --path_mode relative \
  --relative_to /mnt/wangbd8/workspace/DataSets/ThyroidAgent/Classifaction_Data/Malignant_ultrasound_images_cropped \
  --label_key LNM_CN01 \
...
python extract_llnm_shape_echo.py \
  ...
  --output_csv ./output/LymphUs/train_shape_echo.csv \
  --path_mode relative \
  --relative_to /mnt/wangbd8/workspace/DataSets/ThyroidAgent/Classifaction_Data/Lymph_Node_Metastasis/center1/images \
  --label_key LNM_CN01 \
  --mask_threshold 0 \
  --mask_suffix "" \
  --dilation_value 3 \
...
python extract_llnm_shape_echo.py \
  ...
  --output_csv ./output/LymphUs/test_shape_echo.csv \
  --path_mode relative \
...
python new_code/train.py \
  ...
  --radiomics_csv ./output/LymphUs/train_shape_echo.csv \
  --shape_feature llnm_ratio \
  --echo_feature p_norm_echo \
  --batch_size 4 \
  --epochs 50 \
